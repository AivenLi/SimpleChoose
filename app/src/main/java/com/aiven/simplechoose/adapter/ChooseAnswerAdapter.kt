...
) : RecyclerView.Adapter<com.aiven.simplechoose.adapter.ChooseAnswerAdapter.ViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: ChooseAnswerAdapter.ViewHolder, position: Int) {
